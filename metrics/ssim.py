...
def _ssim(img1, img2, window, window_size, channel, size_average=True):
    ...
    sigma1_sq = F.conv2d(img1 * img1, window, padding=padding_size, groups=channel)
    sigma2_sq = F.conv2d(img2 * img2, window, padding=padding_size, groups=channel)
    sigma12_sq = F.conv2d(img1 * img2, window, padding=padding_size, groups=channel)
    ...
    ssim_map = ((2 * mu1_mu2 + C1) * (2 * sigma12_sq + C2)) / (
